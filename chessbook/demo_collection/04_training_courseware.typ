// ============================================================================
// DEMO 4: GIÁO TRÌNH HUẤN LUYỆN BÀI GIẢNG (COURSEWARE) - DẠNG D
// ============================================================================
...
#lesson-header(
  ...
  objective: "Học viên nhận biết được sự khác nhau giữa Đòn ghim Tuyệt đối và Đòn ghim Tương đối."
)
...
#text(9.5pt, weight: "bold", fill: rgb("#2b6cb0"))[2. Bài tập Thực hành trên Lớp]

#v(4pt)

#practice-question(
  number: 1,
  question: "Quân cờ nào có khả năng thực hiện đòn ghim tầm xa?",
  choices: (
    "A. Xe, Tượng, Hậu",
    "B. Mã và Tốt",
    "C. Vua",
  ...
  answer: "A - Xe, Tượng và Hậu là các quân có khả năng ghim."
)
