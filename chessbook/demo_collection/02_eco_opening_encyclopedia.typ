// ============================================================================
// DEMO 2: BÁCH KHOA KHAI CUỘC (ECO OPENING ENCYCLOPEDIA) - DẠNG B
// ============================================================================
...
#opening-diagram-box(
  ...
  caption: "Trắng đứng trước các lựa chọn 6.Bb5+, 6.d3 hoặc 6.Qe2+."
)

#v(8pt)

#text(9pt, weight: "bold")[BẢNG BIẾN THỂ CHÍNH]
...
#text(9pt, weight: "bold")[CHÚ THÍCH PHÂN TÍCH]

#v(4pt)

#note-num(1) *6. Bb5+ c6 7. dxc6 bxc6 8. Bd3:* Nước cờ Steinitz chắc chắn #nag("14").

#note-num(2) *8. Be2 h6 9. Nf3 e4 10. Ne5 Bd6 11. d4 exd3 12. Nxd3 Qc7:* Thế cờ năng động #nag("44").

#note-num(3) *8. Qf3 Rb8:* Đòn ghim phản công sắc bén #nag("36").
